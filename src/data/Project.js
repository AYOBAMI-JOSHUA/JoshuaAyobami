const projects = [
  {
    ...
    description: `
      This website was built for Sona & Son Ltd. 
      It features a responsive design, a contact form powered by EmailJS, 
  ...
  },
  {
    ...
    description: `
      A Spotify-inspired music streaming web app with authentication, 
      premium subscription using Stripe, and dark/light mode support.
    `,
    technologies: ["React", "TailwindCSS", "Stripe API"],
  },
  {
    id: "nike",
    ...
    description: `
      A landing page for Nike products featuring smooth animations, 
      GSAP/Framer transitions, and a mobile-first responsive design.
    `,
  ...
  { 
    ...
    description: `
      ...
      Designed and developed a responsive web application for task organization and personal productivity.
    `,
